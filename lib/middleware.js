...
var createDependencyManagedHandlerFactory = function(handlerFactory, dependencies) {
  ...
  var innerHandlerFactory = createDependencyManagedHandlerFactory(
    handlerFactory, dependencies.slice(1))
...
var createMiddlewareFromFilter = function(filter, dependencies) {
  ...
  var middleware = function(config, handlerFactory, callback) {
    ...
    var configuredHandlerFactory = createDependencyManagedHandlerFactory(filteredHandlerFactory, dependencies)
