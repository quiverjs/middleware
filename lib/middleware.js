...
var createSingleMiddlewareManagedHandlerBuilder = function(handlerBuilder, middleware) {
...
module.exports = {
  ...
  createSingleMiddlewareManagedHandlerBuilder: 
    createSingleMiddlewareManagedHandlerBuilder,

  createMiddlewareManagedHandlerBuilder: 
    createMiddlewareManagedHandlerBuilder,

  createMiddlewareManagedMiddleware: 
    createMiddlewareManagedMiddleware,

  createMiddlewareFromFilter: 
    createMiddlewareFromFilter
}